...
int send_online_video()
{
	...
	params[1] = 50;//压缩的质量参数 该值越大 压缩后的图像质量越好
	...
	while (1) {
		...
		std::cout << " len_encoder= " << len_encoder << std::endl;
		...
		/*cv::Mat  frame1= cv::imdecode(data_encode, CV_LOAD_IMAGE_COLOR);
